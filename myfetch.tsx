...
const FetchItem: React.FC = () => {
  ...
  if (!getFacts) {
    return (
      <div>
        Enter a cat facts API URL, such as https://catfact.ninja/fact.
        Alternatively, paste an invalid url, such as httx://catfact.ninja or
        https://username:password@catfact.ninja/fact
